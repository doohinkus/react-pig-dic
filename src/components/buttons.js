    ...
    return (
      <div>
        <div className={this.props.playing && this.props.name != "Computer" ? 'pa4' : 'hide'}>
          <a onClick={this.props.onClickRoll} className="f5 link pv3 ph4 mr3 mb2 white bg-green pointer">Roll</a>
          <a onClick={this.props.onClickHold} className="f5 link pv3 ph4 mb2 white bg-dark-pink pointer">Hold</a>
        </div>
        <div className='pa4'>
          {message}
        </div>
